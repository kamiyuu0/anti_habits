...
ActiveRecord::Schema[7.2].define(version: 2026_01_04_071922) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["anti_habit_id"], name: "index_bookmarks_on_anti_habit_id"
    t.index ["user_id", "anti_habit_id"], name: "index_bookmarks_on_user_id_and_anti_habit_id", unique: true
  ...
  add_foreign_key "bookmarks", "anti_habits"
